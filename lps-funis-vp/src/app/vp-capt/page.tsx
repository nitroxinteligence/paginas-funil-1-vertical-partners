        ...
        <section className="space-y-6">
          <div className="space-y-4 text-center">
            ...
            <div className="space-y-3 text-slate-700 font-medium text-base leading-relaxed sm:text-lg dark:text-white/85">
              <p>Se você é dono de negócio e ainda resolve tudo na unha, com equipe operacional preguiçosa, talvez isso te incomode um pouco.</p>
              <p>Não é venda. Não é promessa. É demonstração!</p>
              <p>Preencha os dados e se surpreenda.</p>
            </div>
          </div>
            ...
            <CardContent className="space-y-4">
              <form className="space-y-4" onSubmit={handleLeadSubmit}>
                ...
                <ShinyButton type="submit" className="w-full justify-center">
                  {isSubmitting ? "Enviando..." : "Quero continuar agora"}
                </ShinyButton>
                {submitError && (
