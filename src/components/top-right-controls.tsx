    ...
    <>
      ...
      <div className="pointer-events-none fixed right-4 top-4 z-50 sm:right-6 sm:top-6">
        <button
          ...
          className="pointer-events-auto inline-flex h-8 w-12 items-center rounded-full border border-black/10 bg-white/90 p-1 shadow-sm transition-colors dark:border-white/15 dark:bg-black/70"
        >
          <span
            className={`flex h-6 w-6 items-center justify-center rounded-full shadow-md transition-transform ${
              isDark
                ? "translate-x-0 bg-slate-100 text-slate-900"
                : "translate-x-4 bg-gradient-to-br from-sky-400 to-blue-600 text-white"
            }`}
          >
